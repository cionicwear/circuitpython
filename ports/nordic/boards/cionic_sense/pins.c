...
STATIC const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_D0), MP_ROM_PTR(&pin_P0_03) },
    ...
    { MP_ROM_QSTR(MP_QSTR_D6), MP_ROM_PTR(&pin_P0_16) },
    { MP_ROM_QSTR(MP_QSTR_D7), MP_ROM_PTR(&pin_P0_24) },
    { MP_ROM_QSTR(MP_QSTR_D8), MP_ROM_PTR(&pin_P1_09) },
    { MP_ROM_QSTR(MP_QSTR_D9), MP_ROM_PTR(&pin_P1_08) },
    ...
    { MP_ROM_QSTR(MP_QSTR_BNO_BOOTN), MP_ROM_PTR(&pin_P1_04) },
    ...
    { MP_ROM_QSTR(MP_QSTR_SDA2), MP_ROM_PTR(&pin_P0_04) },
    { MP_ROM_QSTR(MP_QSTR_SCL2), MP_ROM_PTR(&pin_P0_05) },
